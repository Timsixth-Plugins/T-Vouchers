...
public final class VouchersPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        IProcessManager<EditProcess> editVoucherManager = new EditVoucherProcessManager(configFile,voucherManager);
        IProcessManager<DeleteProcess> deleteVoucherManager = new DeleteVoucherProcessManager(configFile,voucherManager);
