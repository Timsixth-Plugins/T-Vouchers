...
public final class Placeholders {
    ...
    public static final StaticPlaceholder PLUGIN_VERSION = new StaticPlaceholder("{PLUGIN_VERSION}", VouchersPlugin.getPlugin(VouchersPlugin.class).getDescription().getVersion());
